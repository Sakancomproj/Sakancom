...
public class Main {
	...
	static void menuuser() {
		logger.info(
				"*   press 1 if you want to modify your information in the Sakancom Application.               * \n");
		logger.info(
				"|   press 2 if you want to delete your account from the Sakancom Application.                 | \n");
		logger.info(
				"|   press 3 if you want to show all apartments in Sakancom Application.                       | \n");
		logger.info(
				"|   press 4 if you want to reserve an apartment in Sakancom Application.                      | \n");
		logger.info(
				"|   press 5 if you want to create new order.                                                  | \n");
		logger.info(
				"|   press 6 if you want to delete order.                                                      | \n");
		logger.info(
				"|   press 7 if you want to show specific order information.                                   | \n");
		logger.info(
				"|   press 8 if you want to get the bill.                                                      | \n");
		logger.info(
				"|   press 9 if you want to log out                                                           | \n");
		logger.info(
				"|   press 10 if you want to go to main page                                                   | \n");
	...
	static void menuadmin() {
		...
		logger.info(
				"|   press 1 if you want to create new item in the Sakancom Application.                       | \n");
		logger.info(
				"*   press 2 if you want to update your information about item in the Sakancom Application.    * \n");
		logger.info(
				"|   press 3 if you want to delete your item from the Sakancom Application.                    | \n");
		logger.info(
				"|   press 4 if you want to request the company's income.                                      | \n");
		logger.info(
				"|   press 5 if you want to show all orders in the company.                                    | \n");
		logger.info(
				"|   press 6 if you want to search for user.                                                   | \n");
		logger.info(
				"|   press 7 if you want to search for item.                                                   | \n");
		logger.info(
				"|   press 8 if you want to log out                                                            | \n");
		logger.info(
				"|   press 9 if you want to go to main page                                                   | \n");

	}

	static void menuowner() {
		logger.info(
				"|   press 1 if you want to add an apartment.                                                      | \n");
		logger.info(
				"|   press 2 if you want to delete your apartment from the Sakancom Application.                   | \n");
		logger.info(
				"|   press 3 if you want to show all your apartments.                                              | \n");
		logger.info(
				"|   press 4 if you want to show all reserved apartments                                           | \n");
		logger.info(
				"|   press 5 if you want to log out                                                                | \n");
		logger.info(
				"|   press 6 if you want to go to main page                                                        | \n");
	...
	static void account() {
		...
		logger.info(
				"|   press 3 if you want to exite from app                                                     | \n");
	...
	static void account2() {
		logger.info(
				"|   press 1 if you have an account                                                            | \n");
		logger.info(
				"|   press 2 if you want to exite from app                                                     | \n");
					...
					if (!userlog)
						...
						while (keepRunning) {
							...
							case 2: {
								...
								iduser = scan.next();
								if (logout)
									logger.info("Your account has been cancelled");
							...
							case 5: {
								...
								for (int i = 0; i < db.dborder.size(); i++) {
									if (db.dborder.get(i).id.equals(iduser)
											&& db.dborder.get(i).idorder.equals(idorder)) {
										logger.info("id= ");
							...
							case 9: {
								...
								logger.info(
										"Do you want to continue? (Enter '1' to continue, any other number to exit): ");
